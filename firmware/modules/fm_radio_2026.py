...
#
        ...
        last_state = 1 # reset button to starts unpressed 
        while(1):
            current_state = button.value() 
            
            # Detect NEW button press 
            if current_state == 0 and last_state == 1: #check if currently pressed
                #print (button.value())
                # Clear the buffer
                utime.sleep_ms (20) #debouncer then check again if pressed
            ...
            # Increase volume
                ...
                print("Volume is", fm_radio.Volume)
